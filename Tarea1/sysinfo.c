...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Henry Mariano Ambrocio Terraza Perez");
MODULE_DESCRIPTION("Modulo para leer informacion de memoria y procesos padres e hijos");
MODULE_VERSION("1.0");
